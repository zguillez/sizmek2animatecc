...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		curl: {
			...
			createjs: {
				src: 'https://code.createjs.com/createjs-' + createjs + '.min.js',
				dest: '???/banner_???/lib/createjs.js'
			}
		},
		replace: {
			html: {
				...
				replacements: [{}, {}, {
					...
					from: 'https://code.createjs.com/createjs-' + createjs + '.min.js',
					to: 'lib/createjs.js'
				}, {
					from: 'queue.getResult("???_atlas_")',
					to: 'new createjs.SpriteSheet(???)'
				}, {
					from: 'loader.loadFile',
					to: '//loader.loadFile'
				}, {
					from: 'onload="init();"',
					to: 'onload="checkInit()"'
	...
	grunt.registerTask('run', function (folder) {
		...
		grunt.config.set('curl.createjs.dest', folder + '/banner_' + filename + '/lib/createjs.js');
